...
export default function LOIGenerator(props){
    ...
    function get_image(){
        ...
        .then(text => {
            ...
            //setImage(text.image_url);
            //setImage(require(text.image_url))
            //setImage(require('../../../assets/astronaut.png')); //doesn't work bc outside of src/ scope
            setImage(require('../images/astronaut.png'));
            console.log(image);
        })
    }
    ...
    return (
        <>
            <div className='text-container'>
                <h2>You've reached....a placeholder</h2>
                <h4>
                ...
                {image && <img src={image} width="400px" height="auto" alt='Generated Image'/>}
            </div>
        </>
    )
}